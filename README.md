...
To change to some other libc, for example musl, edit [src/main.c](src/main.c#L189).
...
A custom argument parser is used, and the definition of each option can be found in [src/main.c](src/main.c#L125).
...
Numbers for lacc is from an optimized build produced by clang (-O3), compiled from a single file generated by [amalgamation.py](amalgamation.py).
