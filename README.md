...
C standard library. There is around 11k lines of code total.
...
using gcc and -O3. Hardware performance counter data is gathered with `perf
stat`, and memory allocations with `valgrind`.
