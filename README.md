...
To change to some other Linux libc, for example musl, edit [src/lacc.c](src/lacc.c#L282).
...
A custom argument parser is used, and the definition of each option can be found in [src/lacc.c](src/lacc.c#L209).
